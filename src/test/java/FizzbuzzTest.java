...
public class FizzbuzzTest {
    ...
    @Test
    void returnFizzBuzzWhenNumberIsDivisableByThreeAndFive() {
        Fizzbuzz subject = new Fizzbuzz();
        String result = subject.convert(15);
        assertEquals("FizzBuzz", result);
    }

    @Test
    void returnNumberWhenNumberIsNotDivisableByThreeOrFive() {
        Fizzbuzz subject = new Fizzbuzz();
        String result = subject.convert(4);
        assertEquals("4", result);
    }

    @Test
    void returnStringUpTo100WithFizzBuzzAppliedToThreeAndFive() {
        Fizzbuzz subject = new Fizzbuzz();
